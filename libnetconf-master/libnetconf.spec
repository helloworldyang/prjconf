...
BuildRequires: gcc make doxygen pkgconfig libxml2-devel libxslt-devel  libssh-devel >= 0.6.4 openssl-devel >= 1.0.0 libcurl-devel
...
Group: Liberouter
Requires: libnetconf = %{version}-%{release}  libssh-devel >= 0.6.4 openssl-devel >= 1.0.0
